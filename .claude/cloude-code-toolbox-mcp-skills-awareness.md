...
_Generated: 2026-06-16T07:21:13.240Z_
...
Workspace `mcp.json` _(folder: kashif)_

- **d:\My Portfolio\kashif\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\dell\.claude.json** — _File exists — no servers defined_
