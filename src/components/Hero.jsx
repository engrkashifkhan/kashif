...
const Hero = ({ fadeInUp, handleScroll }) => {
  return (
    <section id="about" className="relative min-h-screen flex items-center bg-[#0A0A0A] overflow-hidden">
      ...
      <div className="container mx-auto px-6 py-20 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <motion.div className="order-2 lg:order-1" {...fadeInUp}>
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white tracking-tight mb-3">
              Kashif <span className="text-slate-500">Khan</span>
            </h1>
            ...
            <p className="text-slate-400 max-w-xl text-base md:text-lg leading-relaxed mb-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <motion.button
                ...
                className="px-8 py-3.5 bg-white text-black font-semibold rounded-lg hover:bg-slate-200 transition-colors shadow-lg shadow-white/5"
              ...
              <motion.button
                ...
                className="px-8 py-3.5 text-slate-300 font-medium rounded-lg border border-slate-700 hover:border-slate-500 hover:text-white transition-colors"
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
              >
                View Tech Stack
          ...
          >
            {/* Image Frame */}
            <div className="relative bg-[#111] p-2 rounded-2xl border border-white/10 shadow-2xl shadow-black/50">
              <img
                src="kashif1.jpeg"
                alt="Kashif Khan"
            ...
            <motion.div
              className="absolute -bottom-6 left-0 md:-left-8 bg-[#0A0A0A] border border-white/10 px-5 py-4 rounded-xl shadow-xl backdrop-blur-sm"
