...
const Education = ({ fadeInUp }) => {
  return (
    <section id="education" className="relative py-24 bg-[#0A0A0A] overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10 max-w-5xl">
        ...
        <motion.div
          className="relative bg-[#11141C] border border-white/5 rounded-2xl p-8 md:p-10 overflow-hidden group"
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-[1.5fr_1fr] gap-8 md:gap-12">
            ...
            <div className="flex flex-col">
              ...
              <p className="text-lg text-slate-400 mb-6 flex items-center gap-2">
            ...
            <div className="flex flex-col gap-6 md:border-l md:border-white/5 md:pl-8">
              <div>
                <h5 className="text-xs font-mono uppercase tracking-wider text-slate-500 mb-2">Duration</h5>
                <p className="text-white font-medium">4 Years (8 Semesters)</p>
              </div>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {['Web Development', 'System Design', 'Algorithms', 'Databases'].map((tag) => (
                    <span key={tag} className="px-3 py-1.5 text-xs font-medium text-slate-300 bg-white/5 border border-white/10 rounded-lg hover:bg-white/10 hover:border-emerald-500/30 transition-colors cursor-default">
                      {tag}
                    </span>
                  ))}
                </div>
