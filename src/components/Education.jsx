    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-10 max-w-5xl">
        ...
        <motion.div
          ...
          {...fadeInUp}
        >
          <span className="block text-xs font-mono tracking-[0.25em] text-emerald-400 uppercase mb-3">
            Academic Background
          </span>
          ...
          <p className="max-w-2xl mx-auto mt-5 text-sm md:text-base leading-7 text-slate-500 dark:text-slate-400">
            My academic background in Software Engineering provided a strong
            foundation in software development, web technologies, algorithms,
            databases, system design, and full-stack application development.
          </p>
        </motion.div>
        ...
        >
          ...
          <div
            aria-hidden="true"
            className="absolute top-0 left-0 w-0 h-0.5 bg-gradient-to-r from-emerald-400 via-cyan-400 to-blue-500 group-hover:w-full transition-all duration-500"
          />
          ...
          <div className="grid grid-cols-1 md:grid-cols-[1.5fr_1fr] gap-8 md:gap-12">
            ...
            <div className="flex flex-col">
              ...
              <p className="text-slate-500 dark:text-slate-400 leading-7">
                Studied Software Engineering with an academic focus on
                software development principles, programming, algorithms,
                databases, system design, software architecture, and
                full-stack web development. The program provided a strong
                foundation for building modern software applications and
                solving practical engineering problems.
              </p>

              <p className="text-slate-500 dark:text-slate-400 leading-7 mt-4">
                My academic experience also strengthened my understanding of
                collaborative development, version control, software
                engineering practices, and the technologies used to develop
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {coreFocus.map((tag) => (
                    <span
                      key={tag}
                      className="px-3 py-1.5 text-xs font-medium text-slate-600 dark:text-slate-300 bg-slate-100 dark:bg-white/5 border border-black/5 dark:border-white/10 rounded-lg hover:bg-slate-200 dark:hover:bg-white/10 hover:border-emerald-500/30 transition-colors cursor-default"
                    >
                      {tag}
                    </span>
                  ))}
